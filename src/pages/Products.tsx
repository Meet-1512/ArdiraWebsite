        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-emerald-50 border border-emerald-100 px-4 py-2 rounded-xl">
              ...
              <span className="text-xs font-bold text-[#43AF57] uppercase tracking-widest">
                Product 01
              </span>
            </div>
      ...
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-3xl p-10 flex items-center justify-center">
              <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-teal-100 overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="bg-teal-600 text-white text-xs font-bold px-4 py-2 rounded-lg text-center">
                    Submit Form
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <p className="text-base md:text-lg font-medium text-teal-600">
              Endless Applications: The 5-star rated Data Collection Solution
              You Need.
            </p>
            <p className="text-slate-500 text-justify text-sm md:text-base leading-relaxed font-normal">
              FormVista is all-in-one Salesforce-native solution for creating,
              managing, and analyzing forms and surveys. Effortlessly collect
              data, integrate with CRM for real-time insights, and act on data
              to enhance experiences, leveraging dynamic forms and robust
              security.
            </p>
            <div className="space-y-3">
              {[
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={u}
                    className="bg-teal-50 border border-teal-200 text-teal-700 px-3 py-1 rounded-full text-xs font-semibold"
                  >
                    {u}
                  </span>
                ))}
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-teal-600 text-white px-6 py-3 rounded-lg font-semibold text-sm hover:bg-teal-700 transition-colors shadow-sm group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border border-teal-300 text-teal-700 bg-white px-6 py-3 rounded-lg font-semibold text-sm hover:bg-teal-50 transition-colors"
              >
                View on AppExchange <ArrowRight size={15} />
              </a>
            </div>
              ...
              <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl border border-violet-100 overflow-hidden">
                ...
                <div className="p-5 space-y-3">
                  {[
                    ...
                    {
                      label: "SOC 2 Evidence Review",
                      status: "In Progress",
                      color: "bg-amber-100 text-amber-700",
                    },
                    {
                      label: "ISO 27001 Audit",
                      status: "Pending",
                      color: "bg-slate-100 text-slate-500",
                    },
                    {
                      label: "HIPAA Risk Assessment",
                      status: "Complete",
                      color: "bg-emerald-100 text-emerald-700",
                    },
                  ].map((item) => (
                    ...
                    >
                      ...
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded-full ${item.color}`}
                      >
                        {item.status}
                      </span>
                    </div>
