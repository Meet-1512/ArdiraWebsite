  ...
  return (
    <div className="min-h-screen bg-slate-50 text-justify text-[#0f172a] font-sans flex flex-col" data-testid="page-terms">
      ...
      <main className="flex-grow pt-32 pb-24 px-6 max-w-3xl mx-auto w-full">
        <h1 className="text-3xl md:text-4xl font-bold font-display mb-10 text-[#43AF57]">Terms of Use</h1>
        
        <div className="space-y-8 text-slate-600 leading-relaxed text-sm md:text-base font-normal">
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Ardira Terms and Conditions</h2>
            <p className="mb-4">
              The website located at www.ardira.com, (the "Website") is published, owned, and operated by Ardira Corporation, its affiliates and related entities ("Ardira", "the Company," "we," "us," and "our"). These Terms of Use (the "Terms") govern your access to and use of the Website.
            </p>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Purpose of the Website</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Use of the Website</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Prohibited Uses</h2>
            <p className="mb-3 font-semibold text-slate-700">You agree that you will not:</p>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Third Party Sites</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Intellectual Property Notices</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Indemnity</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Termination and Restriction of Access</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Arbitration</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Limitation on Time to File Claims</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Governing Law & Jurisdiction</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">Changes to these Terms of Use</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-semibold text-[#0f172a] mb-4">General</h2>
            <p className="mb-4">
